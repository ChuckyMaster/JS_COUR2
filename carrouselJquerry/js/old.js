...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("click", onSliderGoToRandom);
  document
    .querySelector("#slider-previous")
    .addEventListener("click", onSliderGoToPrevious);
  document
    .querySelector("#slider-next")
    .addEventListener("click", onSliderGoToNext);
  document
    .querySelector("#slider-toggle")
    .addEventListener("click", onSliderToggle);
  document
    .querySelector("#toolbar-toggle")
    .addEventListener("click", onToolbarToggle);
